...
def get_survey_responses_digital_data_description(_, blood_barcodes, swab_barcodes):
    return lambda: {  # noqa: E731
        ...
        "currently_currently_smokes_or_vapes": _("choice", items=yes_no_prefer_not_to_say),
        "currently_currently_currently_smokes_or_vapes_description": _("choice", items=yes_no_prefer_not_to_say),
