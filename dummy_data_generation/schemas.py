...
def get_voyager_0_data_description(_, blood_barcodes, swab_barcodes):
    return lambda: {  # noqa: E731
        ...
        "No Email Address": _("custom_random.random_integer", lower=0, upper=2),
        "Bloods Taken": _("custom_random.random_integer", lower=0, upper=2),
        "Bloods Barcode 1": _(
            "discrete_distribution",
        ...
        "Swab Taken": _("custom_random.random_integer", lower=0, upper=2),
        "Swab Barcode 1": _(
            "discrete_distribution",
        ...
        "Consent to First Visit": _("custom_random.random_integer", lower=0, upper=2),
        "Consent to Five Visits": _("custom_random.random_integer", lower=0, upper=2),
        "Consent to Sixteen Visits": _("custom_random.random_integer", lower=0, upper=2),
        "Consent to be Contacted Extra Research": _("custom_random.random_integer", lower=0, upper=2),
        "Consent to Blood Samples": _("custom_random.random_integer", lower=0, upper=2),
        "Consent to Surplus Blood Sample": _("custom_random.random_integer", lower=0, upper=2),
...
def get_voyager_1_data_description(_, blood_barcodes, swab_barcodes):
    return lambda: {  # noqa: E731
        ...
        "Email": _("choice", items=[_("person.email", domains=["gsnail.ac.uk"]), None]),
        "No_Email_address": _("custom_random.random_integer", lower=0, upper=2),
        "Bloods_Taken": _("custom_random.random_integer", lower=0, upper=2),
        "bloods_barcode_1": _(
            "discrete_distribution",
            population=blood_barcodes,
            weights=[1 / len(blood_barcodes)] * len(blood_barcodes),
        ...
        "Swab_Taken": _("custom_random.random_integer", lower=0, upper=2),
        "Swab_Barcode_1": _(
            "discrete_distribution",
            population=swab_barcodes,
            weights=[1 / len(swab_barcodes)] * len(swab_barcodes),
        ...
        "Consent_to_First_Visit": _("custom_random.random_integer", lower=0, upper=2),
        "Consent_to_Five_Visits": _("custom_random.random_integer", lower=0, upper=2),
        "Consent_to_Sixteen_Visits": _("custom_random.random_integer", lower=0, upper=2),
        "Consent_to_Blood_Test": _("custom_random.random_integer", lower=0, upper=2),
        "Consent_to_be_Contacted_Extra_Research": _("custom_random.random_integer", lower=0, upper=2),
        "Consent_to_use_of_Surplus_Blood_Samples": _("custom_random.random_integer", lower=0, upper=2),
