...
voyager_2_data_description = lambda: {  # noqa: E731
    ...
    "1Hour_or_Longer_another_person_home": _(
        "choice",
        items=[None, "1", "2", "3", "4", "5", "6", "7 times or more", "None", "Participant Would Not/Could Not Answer"],
    ),
...
blood_data_description = lambda: {  # noqa: E731
    ...
    "Plate Barcode": _("random.custom_code", mask=f"ONS_######CN-#", digit="#"),
...
if __name__ == "__main__":
    ...
    swab_barcode = swab_barcode[int(round(len(swab_barcode) / 10)) :]
    blood_barcode = blood_barcode[int(round(len(swab_barcode) / 10)) :]
