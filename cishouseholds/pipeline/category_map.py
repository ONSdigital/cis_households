...
category_maps = {
    "iqvia_raw_category_map": {
        ...
        "existing_participant_digital_opt_in_status": {"Participant Opted In": 1, "Participant Opted Out": 0},
        "digital_survey_mode_preference": {"Online": 1, "Telephone": 2},
        "digital_communication_preference": {
            "Email": 1,
            "Letter": 2,
        },
        "sample_return_preference": {
            "Post": 1,
            "Courier": 2,
        },
        "language_preference": {
        ...
        # "digital_entry_pack_status": {},  # Currently no pick list values
        # "existing_participant_digital_opt_in_reminder_1_status": {},  # Currently no pick list values
        # "existing_participant_digital_opt_in_reminder_2_status": {},  # Currently no pick list values
        ...
        "sample_kit_not_dispatched_code": _yes_no_categories,  # TODO Check pick list values link to schema
        ...
        "survey_not_completed_reason_code": {
            "FNR - Full Non Response": 1,
            "QNR - Questionnaire No Return": 2,
            "TNR - Test Not Returned": 3,
        },
        # "allocated_swab_barcode_not_used_reason": {},  # Currently no pick list values
        # "allocated_blood_barcode_not_used_reason": {},  # Currently no pick list values
        "swab_taken": _yes_no_categories,
        ...
        "blood_not_taken_could_not_reason": {
            "I couldn't get enough blood into the pot": 1,
            "The pot spilled": 2,
            "I had bruising or pain": 3,
            "I felt unwell": 4,
        ...
        "work_status_digital": {
            "Employed": 1,
            "In education": 2,
            "Not in paid work. This includes being unemployed or doing voluntary work": 3,
            "Self-employed": 4,
        },
        "work_status_employment": {
            "Currently not working - for example on sick or other leave such as maternity or paternity for longer than 4 weeks": 1,  # noqa: E501
            "Currently working. This includes if you are on sick or other leave for less than 4 weeks": 2,
        },
