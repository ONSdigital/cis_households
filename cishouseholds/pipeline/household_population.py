...
def household_population_total(
    ...
    """
    Create household population dataset by joining 4 dataframes in order to
    calculate the number of households by cis area and country
    Parameters
    ----------
    4 dataframes - df_address_base, df_nspl, df_lsoa, df_country_code
    """
