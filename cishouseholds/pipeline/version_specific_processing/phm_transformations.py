...
def derive_additional_columns(df: DataFrame) -> DataFrame:
    ...
    map_to_bool_columns_dict = {
        ...
        "think_had_other_infection_any_symptom_list_1": "think_had_other_infection_symptom_",
        "think_had_other_infection_any_symptom_list_2": "think_had_other_infection_symptom_",
