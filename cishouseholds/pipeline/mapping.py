...
column_name_maps = {
    "test_participant_data_name_map": {
    ...
    "test_swab_sample_results_name_map": {
    ...
    "test_blood_sample_results_name_map": {
    ...
    "vaccine_capture_column_name_map": {  # Referenced in primary or secondary config
        "participant_id": "participant_id",
        "ons_household_id": "ons_household_id",
    ...
    "soc_resolution_name_map": {  # Referenced in primary or secondary config
        "job_title": "work_main_job_title",
        "main_job_responsibilities": "work_main_job_role",
        "Gold SOC2010 code": "resolved_soc_code",
    },
    "sample_eng_wl_sc_variable_name_map": {  # Referenced in primary or secondary config
    ...
    "sample_ni_variable_name_map": {  # Referenced in primary or secondary config
        "UAC": "unique_access_code",
    ...
    "household_population_variable_name_map": {  # Referenced in primary or secondary config
        "uprn": "uprn",
        "postcode": "postcode",
    ...
    "address_column_map": {  # Referenced in primary or secondary config
    ...
    "postcode_column_map": {  # Referenced in primary or secondary config
        "pcd": "postcode",
    ...
    "master_sample_file_column_map": {  # Referenced in primary or secondary config
        "ons_household_id": "ons_household_id",
        "POSTCODE": "postcode",
    ...
    "population_projection_previous_column_map": {  # Referenced in primary or secondary config
    ...
    "population_projection_current_column_map": {  # Referenced in primary or secondary config
        "laname_21": "local_authority_unitary_authority_name",
        "ladcode_21": "local_authority_unitary_authority_code",
        "region9charcode": "region_code",
        "regionname": "region_name",
    ...
    "aps_column_map": {  # Referenced in primary or secondary config
...
test_survey_response_data_cast_to_double = [
    "infant_age_months_1",
    "infant_age_months_2",
    "infant_age_months_3",
    "infant_age_months_4",
...
test_participant_data_cast_to_double = [
    "infant_age_months_1",
    "infant_age_months_2",
    "infant_age_months_3",
    "infant_age_months_4",
