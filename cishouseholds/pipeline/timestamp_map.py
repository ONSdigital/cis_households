iqvia_v2_time_map = {
    "dd/MM/yyyy": ["symptoms_last_7_days_onset_date",
    ...
    "yyyy-MM-dd'T'HH:mm:ss.SSSS": ["visit_datetime",
                            "samples_taken_datetime"]
}
swab_time_map = {
     "yyyy-MM-dd HH:mm:ss": ["pcr_datetime"]
}

antibody_time_map = {
    "yyyy-MM-dd HH:mm:ss": ["blood_sample_collected_datetime"],
    "yyyy-MM-dd":["blood_sample_arrayed_date",
