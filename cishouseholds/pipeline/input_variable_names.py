...
historic_blood_variable_name_map = {
    ...
    "Date Samples Received Oxford": "blood_sample_received_date",
    "Voyager Date Created": "blood_sample_collected_datetime",
    "siemens_interpretation": "result_siemens",
    "tdi_assay_net_signal": "assay_tdi",
    "siemens_reading": "assay_siemens",
    "lims_id": "lims_id",
}
...
survey_responses_v0_variable_name_map = {
    ...
    "Person 1 age in Years": "person_1_age",
    "Person 2 age in Years": "person_2_age",
    "Person 3 age in Years": "person_3_age",
    "Person 4 age in Years": "person_4_age",
    "Person 5 age in Years": "person_5_age",
    "Person 6 age in Years": "person_6_age",
    "Person 7 age in Years": "person_7_age",
    "Person 8 age in Years": "person_8_age",
    ...
    "Contact with Suspected Covid19 Case": "contact_suspect_positive_covid_last_28_days",
