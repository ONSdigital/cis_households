...
residential_care = match_with_exclusions(
    r"(CARE|NURSING|RESIDENT[^\s]*|OLD PEOPLE[^\s]*|RETIRE[^\s]*|AGING CARE) *(HOME|FACILITY|CENTER|CAE?RE*R)|(SOCIAL|COMMUNITY|DOMICIL[IA]*RY|DOMESTIC){1,} *CARE|CARE *(WORK|ASSISTANT)|ASST CARING|CARE SUPPORT WORK|SUPPORT *WORKER *CARE|INDEPEND[EA]NT LIVING|PERSONAL CARE",
