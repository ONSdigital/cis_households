...
nursing_or_residential_exclusions = r"(MUM|MOTHER|DAD|FATHER|SON|D[AU]+GHT|WIFE|HUSB|PARTNER|CHILD|FAM|T*H*E* ELDERLY)|(DAY|ADULT|COMMUNITY) (CENT(RE|ER))|(CHILD|DAY)\s*(CARE)|NURSERY|(HOME CARER*)|(INDEPENDENT|SUPPORTED|DOMICILIARY) (CARE|LIVING|HOUSING)|(THEIR|OWN|PRIVATE|CLIENT.*?) (HOUSE|HOME)"
