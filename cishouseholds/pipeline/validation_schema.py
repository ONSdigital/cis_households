...
sample_direct_eng_wc_schema = {
    ...
    "in_blood_cohort": {"type": "string", "min": 0, "max": 1},
    ...
    "index_multiple_deprivation": {"type": "string", "min": 0, "max": 32844},
    "cis_area_indicator": {"type": "string", "min": 1, "max": 128},
}
...
sample_northern_ireland_schema = {
    ...
    "index_multiple_deprivation": {"type": "string", "min": 1, "max": 890},
    "cis_area_indicator": {"type": "string", "min": 999, "max": 999},
}
...
iqvia_v2_validation_schema = {
    ...
    "infant_5_age": {"type": "string", "min": 0, "nullable": True},
    "infant_6_age": {"type": "string", "min": 0, "nullable": True},
    "infant_7_age": {"type": "string", "min": 0, "nullable": True},
    "infant_8_age": {"type": "string", "min": 0, "nullable": True},
    ...
    "person_1_age": {"type": "string", "min": 0, "nullable": True},
    "person_2_age": {"type": "string", "min": 0, "nullable": True},
    "person_3_age": {"type": "string", "min": 0, "nullable": True},
    "person_4_age": {"type": "string", "min": 0, "nullable": True},
    "person_5_age": {"type": "string", "min": 0, "nullable": True},
    "person_6_age": {"type": "string", "min": 0, "nullable": True},
    "person_7_age": {"type": "string", "min": 0, "nullable": True},
    "person_8_age": {"type": "string", "min": 0, "nullable": True},
    # should I use max/min for limit the size of the sentence below?
    "person_1_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    # person_1_not_consenting_age is defined as string63, should it be an string?
    "person_1_reason_for_not_consenting": {"type": "string", "nullable": True},
    # person_1 does not specify whether mandatory or not
    "person_2_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    "person_2_reason_for_not_consenting": {"type": "string", "nullable": True},
    "person_3_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    "person_3_reason_for_not_consenting": {"type": "string", "nullable": True},
    "person_4_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    "person_4_reason_for_not_consenting": {"type": "string", "nullable": True},
    "person_5_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    "person_5_reason_for_not_consenting": {"type": "string", "nullable": True},
    "person_6_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    "person_6_reason_for_not_consenting": {"type": "string", "nullable": True},
    "person_7_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    "person_7_reason_for_not_consenting": {"type": "string", "nullable": True},
    "person_8_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    "person_8_reason_for_not_consenting": {"type": "string", "nullable": True},
    "person_9_not_consenting_age": {"type": "string", "min": 0, "nullable": True},
    ...
    "no_email_address": {"type": "string", "min": 0, "max": 1},  # amend dummy data to reflect 0/1 options
