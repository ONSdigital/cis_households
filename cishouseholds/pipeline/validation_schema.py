...
survey_responses_v0_validation_schema = {
    ...
    "Phase": {"type": "string"},
    "No. Paticicpants not Consented": {"type": "string"},
    "Reason Participants not Consented": {"type": "string"},
    "No. Participants not present for Visit": {"type": "string"},
    "Reason Participants not present on Visit": {"type": "string"},
    "Any Household Members Under 2 Years": {"type": "string"},
    "Infant 1 age in Months": {"type": "string"},
    "Infant 2 age in Months": {"type": "string"},
    "Infant 3 age in Months": {"type": "string"},
    "Infant 4 age in Months": {"type": "string"},
    "Infant 5 age in Months": {"type": "string"},
    "Infant 6 age in Months": {"type": "string"},
    "Infant 7 age in Months": {"type": "string"},
    "Infant 8 age in Months": {"type": "string"},
    "Any Household Members Over 2 Not Present": {"type": "string"},
    "Person 1 age in Years": {"type": "string"},
    "Person 2 age in Years": {"type": "string"},
    "Person 3 age in Years": {"type": "string"},
    "Person 4 age in Years": {"type": "string"},
    "Person 5 age in Years": {"type": "string"},
    "Person 6 age in Years": {"type": "string"},
    "Person 7 age in Years": {"type": "string"},
    "Person 8 age in Years": {"type": "string"},
    "Person 1 Not Consenting (Age in Years)": {"type": "string"},
    "Reason for Not Consenting (Person 1)": {"type": "string"},
    "Person 2 Not Consenting (Age in Years)": {"type": "string"},
    "Reason for Not Consenting (Person 2)": {"type": "string"},
    "Person 3 Not Consenting (Age in Years)": {"type": "string"},
    "Reason for Not Consenting (Person 3)": {"type": "string"},
    "Person 4 Not Consenting (Age in Years)": {"type": "string"},
    "Reason for Not Consenting (Person 4)": {"type": "string"},
    "Person 5 Not Consenting (Age in Years)": {"type": "string"},
    "Reason for Not Consenting (Person 5)": {"type": "string"},
    "Person 6 Not Consenting (Age in Years)": {"type": "string"},
    "Reason for Not Consenting (Person 6)": {"type": "string"},
    "Person 7 Not Consenting (Age in Years)": {"type": "string"},
    "Reason for Not Consenting (Person 7)": {"type": "string"},
    "Person 8 Not Consenting (Age in Years)": {"type": "string"},
    "Reason for Not Consenting (Person 8)": {"type": "string"},
    "Person 9 Not Consenting (Age in Years)": {"type": "string"},
    ...
    "DoB": {"type": "string"},
    "Email": {"type": "string"},
    "No Email Address": {"type": "string"},
    "Bloods Taken": {"type": "string"},
    "Bloods Barcode 1": {"type": "string"},
    "Swab Taken": {"type": "string"},
    "Swab Barcode 1": {"type": "string"},
    "Date/Time Samples Taken": {"type": "string"},
    "Sex": {"type": "string"},
    "Gender": {"type": "string"},
    "Ethnicity": {"type": "string"},
    "Consent to First Visit": {"type": "string"},
    "Consent to Five Visits": {"type": "string"},
    "Consent to Sixteen Visits": {"type": "string"},
    "Consent to be Contacted Extra Research": {"type": "string"},
    "Consent to Blood Samples": {"type": "string"},
    "Consent to Surplus Blood Sample": {"type": "string"},
...
survey_responses_v1_validation_schema = {
    ...
    "Postcode": {"type": "string"},
    "Cohort": {"type": "string"},
    "No_Paticicpants_not_Consented": {"type": "string"},
    "Reason_Participants_not_Consented": {"type": "string"},
    "No_Participants_not_present_for_Visit": {"type": "string"},
...
survey_responses_v2_validation_schema = {
    ...
    "NotAttendReason": {"type": "string"},
    "Type_of_Visit": {"type": "string"},
    "Visit_Order": {"type": "string"},
    "Work_Type_Picklist": {"type": "string"},
    "Visit_Date_Time": {"type": "string"},
    "Visit_Date_type": {"type": "string"},
    ...
    "Symptoms_7_Chest_pain": {"type": "string"},
    "Symptoms_7_Palpitations": {"type": "string"},
    "Symptoms_7_Vertigo_dizziness": {"type": "string"},
    "Symptoms_7_Worry_anxiety": {"type": "string"},
    "Symptoms_7_Low_mood_not_enjoying_anything": {"type": "string"},
    "Symptoms_7_Memory_loss_or_confusion": {"type": "string"},
    "Symptoms_7_Difficulty_concentrating": {"type": "string"},
    "Are_you_self_Isolating_S2": {"type": "string"},
    "Do_you_think_you_have_Covid_Symptoms": {"type": "string"},
    "Contact_Known_Positive_COVID19_28_days": {"type": "string"},
    "If_Known_last_contact_date": {"type": "string"},
    ...
    "Previous_Symptoms_Chest_pain": {"type": "string"},
    "Previous_Symptoms_Palpitations": {"type": "string"},
    "Previous_Symptoms_Vertigo_dizziness": {"type": "string"},
    "Previous_Symptoms_Worry_anxiety": {"type": "string"},
    "Previous_Symptoms_Low_mood_not_enjoying_anything": {"type": "string"},
    "Previous_Symptoms_Memory_loss_or_confusion": {"type": "string"},
    "Previous_Symptoms_Difficulty_concentrating": {"type": "string"},
    "If_yes_Date_of_first_symptoms": {"type": "string"},
    "Did_you_contact_NHS": {"type": "string"},
    "Were_you_admitted_to_hospital": {"type": "string"},
    "Have_you_had_a_swab_test": {"type": "string"},
    ...
    "Date_Of_Vaccination": {"type": "string"},
    "Type_Of_Vaccination_1": {"type": "string"},
    "Vaccination_Other_1": {"type": "string"},
    "Date_Of_Vaccination_1": {"type": "string"},
    "Type_Of_Vaccination_2": {"type": "string"},
    "Vaccination_Other_2": {"type": "string"},
    "Date_Of_Vaccination_2": {"type": "string"},
    "Type_Of_Vaccination_3": {"type": "string"},
    "Vaccination_Other_3": {"type": "string"},
    "Date_Of_Vaccination_3": {"type": "string"},
    "Type_Of_Vaccination_4": {"type": "string"},
    "Vaccination_Other_4": {"type": "string"},
    "Date_Of_Vaccination_4": {"type": "string"},
