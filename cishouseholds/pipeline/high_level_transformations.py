...
def reclassify_work_variables(df: DataFrame) -> DataFrame:
    ...
    update_work_status_self_employed_v1_a = furlough_regex_hit & flag_records_for_self_employed_rules_v1_a()
    update_work_status_self_employed_v1_b = furlough_regex_hit & flag_records_for_self_employed_rules_v1_b()
    update_work_status_self_employed_v2_a = furlough_regex_hit & flag_records_for_self_employed_rules_v2_a()
    update_work_status_self_employed_v2_b = furlough_regex_hit & flag_records_for_self_employed_rules_v2_b()
