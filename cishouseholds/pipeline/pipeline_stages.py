...
def sample_file_ETL(
    ...
    table_or_path = "path"
    if check_table_exists(output_design_weight_table):
        table_or_path = "table"
...
def population_projection(
    ...
    table_or_path = "path"
    if check_table_exists(output_population_projections_table):
        table_or_path = "table"
        population_projection_previous = output_population_projections_table
    files = {
