...
#     )
#     hh_samples_df = hh_samples_df.join(
#         df=df_extract_by_country, on=f"population_country_{population_join_column}", how="left"
#     )
#     return df
# # 1179 part1
...
#             "condition": (F.col("country_name") == "england"),
#             "operation": (
#                 (F.col("interim_region_code") - 1) * 10 + (F.col("interim_sex") - 1) * 5 + F.col("age_group_antibodies") # noqa: E501
#             ),
#         },
#         "p1_for_antibodies_28daysto_engl": {
