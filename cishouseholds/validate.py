...
def validate_csv_fields(csv_file:str, delimiter:str=","):
    ...
    if row_errors:
        raise InvalidFileError(f"Expected number of fields in each row is {n_fields}",
...
def validate_csv_header(csv_file:str, expected_header:str, delimiter:str=","):
    ...
    if expected_header is not None:
            ...
            if is_match is False:
                raise InvalidFileError(f"Header of csv file {csv_file} does not match expected header",
