...
from cishouseholds.filter import assign_date_interval_and_flag_if_outside


def test_assign_date_interval_and_flag_if_outside(spark_session):
    expected_schema = """
    ...
    actual_df = assign_date_interval_and_flag_if_outside(
    ...
    actual_df = assign_date_interval_and_flag_if_outside(
        input_df, "outside_interval_flag", "diff_interval_days", "date_1", "date_2", -0.5, 2, interval_format="days"
    )
