...
#                     'column_3 should be in between lower_bound and upper_bound',
#                     'col_2 and col_3 should_be_within_interval 4 and 10',
#                     'column_1, column_3 should be unique', 'larger_than_10'
#                     ]
#                 ),
#                 ('b',   2,  7,  'no', [
...
#         data=[
#             # fmt: off
#                 (1,     'yes',  'yes',  'yes',    ['social_care check pass']),
#                 (1,     'yes',  'no',   'yes',    ['social_care check pass']),
#                 (1,     'yes',  'yes',  'no',    ['social_care check pass']),
#                 (1,     'yes',  'no',   'no',    ['social_care check NOT pass']),
#             # fmt: on
#         ],
#         schema=StructType(
#             [
#                 StructField("patient_id", IntegerType(), True),
#                 StructField("work_social_care", StringType(), True),
#                 StructField("work_care_nursing_home", StringType(), True),
#                 StructField("work_direct_contact", StringType(), True),
#                 StructField("error", ArrayType(StringType()), True),
#             ]
#         ),
#     )
