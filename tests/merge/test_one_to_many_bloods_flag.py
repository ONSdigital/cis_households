...
def test_one_to_many_bloods_flag(spark_session):
    ...
    expected_df = spark_session.createDataFrame(
        data=[
            ...
            (1, "2029-01-01", "ONS00000003", "positive", "ONS00000003", "2029-01-01", 4, "positive", 0.0, 1),
            ...
            (1, "2029-01-02", "ONS00000004", "negative", "ONS00000004", "2029-01-02", 2, "negative", 0.0, 1),
            (1, "2029-01-01", "ONS00000004", "negative", "ONS00000004", "2029-01-02", 2, "negative", 24.0, 1),
            (1, "2029-01-02", "ONS00000004", "negative", "ONS00000004", "2029-01-03", 2, None, 24.0, 1),
            (1, "2029-01-01", "ONS00000004", "negative", "ONS00000004", "2029-01-03", 2, None, 48.0, 1),
            (1, "2029-01-06", "ONS00000004", "positive", "ONS00000005", "2029-01-05", 3, "positive", -24.0, None),
            (1, "2029-01-06", "ONS00000005", "positive", "ONS00000005", "2029-01-06", 3, "positive", 0.0, 1),
            (1, "2029-01-04", "ONS00000006", "negative", "ONS00000006", "2029-01-05", 3, "negative", 24.0, None),
            (1, "2029-01-04", "ONS00000007", "negative", "ONS00000007", "2029-01-05", 3, "positive", 24.0, None),
        ],
    ...
    data_iq = [
        ...
        (1, "2029-01-04", "ONS00000007", "negative"),
