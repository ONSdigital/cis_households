...
def test_many_to_one_swab_flag(spark_session):
    ...
    expected_df = spark_session.createDataFrame(
        data=[
            ("ABC123", None, 24, 0, 1, 2, 1, 1),
            ("ABC123", None, 28, 4, 1, 2, 1, 1),
            ("ABC456", None, 48, 24, 1, 2, 1, 1),
            ("ABC456", None, 48, 24, 1, 2, 1, 1),
            ("ABC789", None, 28, 4, 1, 2, 1, None),
            ("ABC789", None, 36, 12, 1, 2, 1, 1),
            ("DEF123", None, 25, 1, 1, 3, 1, None),
            ("DEF123", None, 35, 11, 1, 3, 1, 1),
            ("DEF123", None, 38, 14, 1, 3, 1, 1),
            ("DEF456", None, -1, 25, 1, 2, 1, None),
            ("DEF456", None, 57, 33, 1, 2, 1, 1),
            ("DEF789", None, 7, 17, 1, 2, 1, None),
            ("DEF789", None, 41, 17, 1, 2, 1, 1),
            ("GHI123", None, 20, 4, 1, 2, 1, None),
            ("GHI123", None, 37, 13, 1, 2, 1, 1),
            ("GHI456", 1, 20, 4, 1, 2, None, None),
            ("GHI456", 1, 37, 13, 1, 2, None, None),
            ("GHI789", None, 25, 1, 1, 3, 1, None),
            ("GHI789", None, 35, 11, 1, 3, 1, 1),
            ("GHI789", 1, 38, 14, 1, 3, None, None),
        ],
