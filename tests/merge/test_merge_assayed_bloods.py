...
def test_merge_assayed_bloods(spark_session):
    input_df = spark_session.createDataFrame(
        ...
        schema="blood_group string, blood_sample_barcode string, antibody_test_plate_number integer, antibody_test_well_id integer, col1 integer, col2 integer, col3 integer, col4 integer",
    )
    expected_df = spark_session.createDataFrame(
        data=[
            ("ONS00000005",None,"S", 1,None,None,None, None,None,None,None,None),
        ...
        schema="blood_sample_barcode string ,antibody_test_plate_number integer,antibody_test_well_id integer,blood_group_s string ,col1_s integer,col2_s integer,col3_s integer,col4_s integer,blood_group_n string,col1_n integer,col2_n integer,col3_n integer,col4_n integer",
    )
