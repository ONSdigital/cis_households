...
def test_many_to_one_antibody_flag(spark_session):
    ...
    expected_df = spark_session.createDataFrame(
        ...
        schema="antibody_barcode_cleaned string, out_of_date_range_antibody integer, count_barcode_antibody integer, \
                count_barcode_voyager integer, identify_many_to_one_antibody_flag integer, \
                drop_many_to_one_antibody_flag integer",
    )

    input_df = expected_df.drop("drop_many_to_one_antibody_flag, identify_many_to_one_antibody_flag")

    output_df = many_to_one_antibody_flag(input_df, "drop_many_to_one_antibody_flag", "antibody_barcode_cleaned")
