...
def test_merge_survey_tables():
    output_df = merge_survey_tables(tables=["hdfs:////ons/covserolink/hive/stef_transformed_survey_responses_v0_data/part-00000-a8d04ad1-48da-49e8-8bf1-eebdfd18b55f-c000.snappy.parquet", 
