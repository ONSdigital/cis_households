...
def test_merge_previous_imputed_values(spark_session):
    ...
    input_data = [(0, 42, 1, "imputation_method_1"), (1, None, 0, None), (2, 365, 0, None)]

    lookup_data = [
        (0, 101, 1, "inputation_method_2"),
        (1, 500, 1, "imputation_method_3"),
        (2, 500, 1, "imputation_method_1"),
    ]

    expected_data = [(0, 42, 1, "imputation_method_1"), (1, 500, 1, "imputation_method_3"), (2, 365, 0, None)]
