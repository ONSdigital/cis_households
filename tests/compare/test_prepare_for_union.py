...
def test_prepare_for_union(spark_session):
    ...
    expected_df = spark_session.createDataFrame(
        data=[
            (1, "ABC123", 1, 2, None, None, 6, None),
            (2, "ABC123", 2, 3, None, None, 5, None),
            (3, "ABC456", 1, 4, None, None, 4, None),
            (4, "ABC456", 2, 4, None, None, 3, None),
            (5, "ABC789", 1, 2, None, None, 2, None),
            (6, "ABC789", 2, 1, None, None, 1, None),
        ],
    ...
    expected_ref = spark_session.createDataFrame(
        data=[
            (1, "ABC7673", None, None, 1, 2, 2, "ABC123"),
            (1, "ABC7234", None, None, 1, 2, 2, "ABC123"),
            (1, "ABC7216", None, None, 1, 2, 1, "ABC456"),
            (1, "ABC7837", None, None, 1, 2, 1, "ABC456"),
            (1, "ABC7893", None, None, 1, 2, 2, "ABC789"),
            (1, "ABC7810", None, None, 1, 2, 2, "ABC789"),
        ],
        schema="test_1 integer, test_2 string, \
               new_col_1 integer, new_col_2 integer, col_2 integer, col_3 integer, test_3 integer, col_1 string",
    )
