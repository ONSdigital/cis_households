...
def responses_v2_survey_ETL_output(mimesis_field, pandas_df_to_temporary_csv):
    ...
    csv_file = pandas_df_to_temporary_csv(pandas_df, sep="|")
...
@pytest.mark.integration
def test_responses_version_2_delta_schema(responses_v2_survey_ETL_output, regression_test_schema):
    regression_test_schema(responses_v2_survey_ETL_output, "processed_responses_v2")
