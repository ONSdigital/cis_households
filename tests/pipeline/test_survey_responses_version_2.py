...
from cishouseholds.pipeline.survey_responses_version_2_ETL import survey_responses_version_2_ETL, transform_survey_responses_version_2_delta
...
def iqvia_v2_survey_dummy_df(spark_session):
    ...
    v2_data_description = (
        lambda: {
                ...
                "Visit_ID" : _('choice', items=[_('random.custom_code', mask='DVS-##########', digit='#'), 
                ...
                "Fingerprick_Status_Participant" : _('choice', items=[None, "Accepted", "Consented", "Declined", "Invited", "Not invited"]),
                ...
                "Person_8": _('choice', items=[None, _('integer_number', start=0, end=100)]),
                            'Person_1_Not_Consenting_Age': _('choice', 
                                             items=[_('integer_number', start=0, end=26), None]),           
                'Person1_Reason_for_Not_Consenting': _('choice', 
                                items=["0","Don't want to participate","[REDACTED]",
                                        "N","N/A","N/a","N:a","NA","NONE","Na","No","Not interested",
                                        "[REDACTED]","an","[REDACTED]","[REDACTED]", None]),
                'Person_2_Not_Consenting_Age': _('choice', 
                                             items=[_('integer_number', start=0, end=26), None]),             
                'Person2_Reason_for_Not_Consenting': _('choice', 
                                items=["0","Don't want to participate","[REDACTED]",
                                        "N","N/A","N/a","N:a","NA","NONE","Na","No","Not interested",
                                        "[REDACTED]","an","[REDACTED]","[REDACTED]", None]),
                'Person_3_Not_Consenting_Age': _('choice', 
                                             items=[_('integer_number', start=0, end=26), None]),       
                'Person3_Reason_for_Not_Consenting': _('choice', 
                                items=["0","Don't want to participate","[REDACTED]",
                                        "N","N/A","N/a","N:a","NA","NONE","Na","No","Not interested",
                                        "[REDACTED]","an","[REDACTED]","[REDACTED]", None]),
                'Person_4_Not_Consenting_Age': _('choice', 
                                             items=[_('integer_number', start=0, end=26), None]),       
                'Person4_Reason_for_Not_Consenting': _('choice', 
                                items=["0","Don't want to participate","[REDACTED]",
                                        "N","N/A","N/a","N:a","NA","NONE","Na","No","Not interested",
                                        "[REDACTED]","an","[REDACTED]","[REDACTED]", None]),
                'Person_5_Not_Consenting_Age': _('choice', 
                                             items=[_('integer_number', start=0, end=26), None]),           
                'Person5_Reason_for_Not_Consenting': _('choice', 
                                items=["0","Don't want to participate","[REDACTED]",
                                        "N","N/A","N/a","N:a","NA","NONE","Na","No","Not interested",
                                        "[REDACTED]","an","[REDACTED]","[REDACTED]", None]),
                'Person_6_Not_Consenting_Age': _('choice', 
                                             items=[_('integer_number', start=0, end=26), None]),            
                'Person6_Reason_for_Not_Consenting': _('choice', 
                                items=["0","Don't want to participate","[REDACTED]",
                                        "N","N/A","N/a","N:a","NA","NONE","Na","No","Not interested",
                                        "[REDACTED]","an","[REDACTED]","[REDACTED]", None]),
                'Person_7_Not_Consenting_Age': _('choice', 
                                             items=[_('integer_number', start=0, end=26), None]),         
                ...
                'Person_8_Not_Consenting_Age': _('choice', 
                                             items=[_('integer_number', start=0, end=26), None]),           
                'Person8_Reason_for_Not_Consenting': _('choice', 
                                items=["0","Don't want to participate","[REDACTED]",
                                        "N","N/A","N/a","N:a","NA","NONE","Na","No","Not interested",
                                        "[REDACTED]","an","[REDACTED]","[REDACTED]", None]),                 
                'Person_9_Not_Consenting_Age': _('choice', 
                                items=[_('integer_number', start=0, end=28), None]),
                'Person9_Reason_for_Not_Consenting': _('choice', 
                                items=["0","Consenting","Don't want to participate",
                                        "[REDACTED]","Left To go to uni","N","N/A",
                                        "N/a","NA","NONE","Na","No","Not interested",
                                        "The","[REDACTED]","[REDACTED]","na", None]),                
            ...
            # integer choice
                ...
                'bloods_barcode_1': _('choice', items=[_('random.custom_code', mask='ONS############', digit='#'), 
                                                   _('random.custom_code', mask='ONW############', digit='#'),
                                                   _('random.custom_code', mask='ONC############', digit='#'),
                                                   _('random.custom_code', mask='ONN############', digit='#'),
                                                        None]),
                'Swab_Barcode_1': _('choice', items=[_('random.custom_code', mask='ONS############', digit='#'), 
                                                   _('random.custom_code', mask='ONW############', digit='#'),
                                                   _('random.custom_code', mask='ONC############', digit='#'),
                                                   _('random.custom_code', mask='ONN############', digit='#'),
                                                        None]),
            # UNCOMMON date format:  yyyy-mm-ddThh:mm:??.????
                'Date_Time_Samples_Taken': _('choice', items=[_('datetime.formatted_datetime', fmt="%Y-%m-%d%w%M:%S.%f", start=2020, end=2022), None]), 
                ...
                'Date_of_first_symptom_onset': _('choice', items=[None, _('datetime.formatted_datetime', fmt="%d/%b/%Y", start=2020, end=2022)]),
                ...
                'If_Known_last_contact_date': _('choice', items=[_('datetime.formatted_date', fmt="%d-%m-%Y", start=2018, end=2022), None]),
                ...
                'If_suspect_last_contact_date': _('choice', items=[_('datetime.formatted_date', fmt="%d-%m-%Y", start=2018, end=2022), None]),
                ...
                'If_yes_Date_of_first_symptoms': _('choice', items=[_('datetime.formatted_datetime', fmt="%d/%m/%Y", start=2020, end=2022), None]),
                ...
                'Where_was_the_test_done': _('choice', items=["Home Test", "In the NHS (e.g. GP or hospital)", 
                                                                ...
                                                                None]),
                'If_ve_Blood_Date_of_1st_ve_test': _('choice', items=[_('datetime.formatted_datetime', fmt="%d/%m/%Y", start=2020, end=2022), None]),
                'If_all_ve_blood_Date_last_ve_test': _('choice', items=[_('datetime.formatted_datetime', fmt="%d/%m/%Y", start=2020, end=2022), None]),
                ...
                'Date_Of_Vaccination': _('choice', items=[_('datetime.formatted_datetime', fmt="%d/%m/%Y", start=2020, end=2022), None]),
                ...
                'been_outside_uk_last_date': _('choice', items=[_('datetime.formatted_datetime', fmt="%d/%m/%Y", start=2020, end=2022), None]),
