...
def test_transform_antibody_swab_ETL(spark_session):
    ...
    """
    expected_data = [
        ("DHR-30069000069", None, None, None, None, None, None, None),
        ("DHR-30076000069", None, "old", None, None, None, None, None),
        ("DHR-30021600042", 10012345678, "new", None, 1, 1, 1, 1),
        ("DHR-30007860069", 10012345678, "new", None, 1, 1, 1, 1),
        ("DHR-30084600055", 10012346658, "new", None, 1, 1, 1, 1),
        (
            "DHR-30026900012",
            10014342678,
            "new",
