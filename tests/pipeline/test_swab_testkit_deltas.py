...
def test_swab_testkit_delta_ETL_df(swab_delta_ETL_output, regression_test_df):
    regression_test_df(
...
@pytest.mark.integration
def test_swab_testkit_delta_ETL_schema(swab_delta_ETL_output, regression_test_df_schema):
