...
def test_match_type(spark_session):
    ...
    input_df = spark_session.createDataFrame(
        data=[
            ...
            (
                ...
                None,
                5,
            ),  # no ppt match for lab results and lab result <= 28 days ago
            (
                "B",
                False,
                True,
                ...
                None,
                5,
            ),  # no ppt match for lab result and lab result was > 28 days ago
            (
                "C",
                True,
                False,
                ...
                "2020-03-01",
                None,
            ),  # no lab match for ppt and survey_completed <= 7 days ago or window closed <= 7 days ago
            (
                "D",
                True,
                False,
            ...
            (
                ...
                "2020-03-01",
                5,
            ),  # ppt match where days between result received and sample_taken <= 28 and negative
            (
                "F",
                False,
                False,
                ...
                "2020-03-01",
                50,
            ),  # ppt match where days between result received and sample_taken <= 28 and positive
            (
                "G",
                False,
                False,
                ...
                "2020-03-01",
                250,
            ),  # ppt match where days between result received and sample_taken <= 28 and higher level
            (
                "H",
                False,
                False,
                ...
                "2020-03-01",
                50,
            ),  # ppt match where days between result received and sample_taken >= 28
        ],
        schema=schema,
    )
    expected_df = spark_session.createDataFrame(
        # fmt: off
        data=[
            ("A", False, True,  "2020-03-30", "2020-03-20", None,         None,         None,         5,    None,               None,                                        None), # no ppt match for lab results and lab result <= 28 days ago
            ("B", False, True,  "2020-03-30", "2020-03-01", None,         None,         None,         5,    "lab orphan",       "test void",                                 None), # no ppt match for lab result and lab result was > 28 days ago
            ("C", True,  False, "2020-03-30", None,         "2020-03-26", "2020-03-30", "2020-03-01", None, None,               None,                                        None), # no lab match
            ("D", True,  False, "2020-03-30", None,         "2020-03-10", "2020-03-20", "2020-03-01", None, "survey orphan",    "test failed",                               None), # no lab match for ppt and survey_completed >= 7 days ago or window closed >= 7 days ago
