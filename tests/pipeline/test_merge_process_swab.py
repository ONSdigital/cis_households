...
def test_merge_process_swab(spark_session):
    ...
    schema = """
                ...
                pcr_result_classification string, unique_id_swab integer,
                count_barcode_swab integer, diff_vs_visit_hr double,
                out_of_date_range_swab integer, abs_offset_diff_vs_visit_hr double,
                identify_one_to_many_swabs_flag integer, time_order_flag integer,
                pcr_flag integer, time_difference_flag integer,
                drop_flag_one_to_many_swab integer,
                identify_many_to_one_swab_flag integer,
                drop_flag_many_to_one_swab integer,
                identify_many_to_many_flag integer,
                failed_flag_many_to_many_swab integer,
                drop_flag_many_to_many_swab integer,
                1_to_mb integer, m_to_1b integer, m_to_mb integer,
                failed_one_to_many_swab integer,
                failed_many_to_one_swab integer,
                failed_many_to_many_swab integer
            """
    data = [
        (
            "ONS0003",
