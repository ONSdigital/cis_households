...
def load_test_cases():
    ...
    # row_id = 1
    expected_data = test_data.query(f"record_type=='expected' and row_id==13").drop(columns=["record_type"])

    input_data = test_data.query(f"record_type=='input' and row_id==13").drop(
