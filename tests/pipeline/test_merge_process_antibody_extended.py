...
def test_merge_process_antibody(spark_session):
    ...
    data = [
        ...
        ("H", "2020-01-01", "2020-06-02", "2020-01-04 12:00:00", "positive", "positive", "positive", "out of range"),
        ("J", "2020-01-01","2020-01-02","2020-01-04 12:00:00","positive","positive","positive","NOT out of range"),
        ("K","2020-01-01","2020-01-02","2020-01-04 12:00:00","positive","positive","positive","NOT out of range"),
        ("K","2020-01-01","2020-01-02","2020-01-04 12:00:00","positive","positive","positive","NOT out of range"),
        ("L","2020-01-01","2020-01-02","2020-01-04 12:00:00","positive","positive","positive","NOT out of range"),
        ("M","2020-01-01","2020-01-02","2020-01-04 12:00:00","positive","positive","positive","NOT out of range"),
        ("M","2020-01-01","2020-01-02","2020-01-04 12:00:00","positive","positive","positive","NOT out of range"),
        ("N","2020-01-01","2020-01-02","2020-01-04 12:00:00","positive","positive","positive","time_order_flag - closest to visit"),
        ("N","2020-01-01","2020-01-03","2020-01-04 12:00:00","positive","positive","positive","time_order_flag - NOT closest to visit"),
        ("P","2020-01-01","2020-01-04","2020-01-04 12:00:00","positive","positive","positive","time_order_flag - NOT closest to visit"),
        ("Q","2020-01-01","2020-01-02","2020-01-04 12:00:00","positive","positive","positive","time_order_flag - closest to visit"),
        ("Q","2020-01-01","2020-01-03","2020-01-04 12:00:00","positive","positive","positive","time_order_flag - NOT closest to visit"),
