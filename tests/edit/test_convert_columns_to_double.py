...
from cishouseholds.edit import convert_columns_to_double


def test_convert_columns_to_double(spark_session):
    ...
    output_df = convert_columns_to_double(input_df, columns_list)
