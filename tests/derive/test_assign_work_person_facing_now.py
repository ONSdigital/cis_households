...
def test_assign_work_person_facing_now(spark_session):
    expected_df = spark_session.createDataFrame(
        data=[
            ...
            ("Yes", 27, "Yes, care/residential home, resident-facing", "Yes, care/residential home, resident-facing"),
            ("Yes", 49, "Yes, other social care, resident-facing", "Yes, other social care, resident-facing"),
            ("No", 33, "No", "No"),
            (">=75y", 80, "No", ">=75y"),
    ...
    output_df = assign_work_person_facing_now(
        expected_df.drop("facing"), "facing", "age", "work_patient", "work_social"
    )
