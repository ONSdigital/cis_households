...
def test_assign_valid_order_2(spark_session):
    expected_df = spark_session.createDataFrame(
        # fmt: off
        data=[
            (1, "2021-01-01", "Pfizer",             "2021-01-02 00:00:00.0",        1,      9,      9),
            (1, "2021-01-30", "Pfizer",             "2021-02-02 00:00:00.0",        2,      3,      3),
            (1, "2021-02-28", "Pfizer",             "2021-03-01 00:00:00.0",        3,      7,      7),
            (2, "2021-01-01", "Pfizer/AZ/Moderna",  "2021-01-02 00:00:00.0",        1,      9,      9),
            (2, "2021-01-29", "Pfizer/AZ/Moderna",  "2021-02-03 00:00:00.0",        2,      1,      1),
            (2, "2021-02-28", "Pfizer/AZ/Moderna",  "2021-03-04 00:00:00.0",        3,      1,      1),
            (3, "2021-01-01", "Other",              "2021-01-03 00:00:00.0",        1,      9,      9),
            (3, "2021-03-26", "Other",              "2021-03-27 00:00:00.0",        2,      7,      7),
            (3, "2021-04-14", "Other",              "2021-04-16 00:00:00.0",        3,      7,      7),
        ],
        # fmt: on
        schema="id integer, vaccine_date string, vaccine_type string, visit_datetime string, doses integer, order integer, order_2 integer",
    )
    for col in ["vaccine_date", "visit_datetime"]:
        expected_df = expected_df.withColumn(col, F.to_timestamp(col))
