...
def test_flag_records_for_college_v2_rules(spark_session):
    ...
    test_cases = [
        ...
        ("Looking for paid work and able to start", 5, 15, False),
        ("Looking for paid work and able to start", 5, 16, True),
        ("Not working and not looking for work", 6, 15, False),
        ("Not working and not looking for work", 6, 16, True),
        ("Retired", 7, 15, False),
        ("Retired", 7, 16, True),
