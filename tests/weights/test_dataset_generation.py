...
from cishouseholds.weights.pre_calibration import dataset_flag_generation_ever_never
...
def test_dataset_generation_ever_never_swab(spark_session):
    ...
    output_df = dataset_flag_generation_ever_never(
        df=input_df,
        column_test_result="test_result",
        patient_id_column="patient_id",
        visit_date_column="visit_date",
        age_column="age",
        ever_never_column="ever_never",
        type_test="swab",
    )
    import pdb
